	my_sys_mgc_axi4_master_0 #(
		...
		.AWADDR   (_connected_to_AWADDR_),   //  output,  width = 16,                   .awaddr
		.AWID     (_connected_to_AWID_),     //  output,  width = 18,                   .awid
		.AWUSER   (_connected_to_AWUSER_),   //  output,   width = 8,                   .awuser
		.ARADDR   (_connected_to_ARADDR_),   //  output,  width = 16,                   .araddr
		.ARID     (_connected_to_ARID_),     //  output,  width = 18,                   .arid
		...
		.BUSER    (_connected_to_BUSER_),    //   input,   width = 8,                   .buser
		.RDATA    (_connected_to_RDATA_),    //   input,  width = 32,                   .rdata
		.RID      (_connected_to_RID_),      //   input,  width = 18,                   .rid
		.WDATA    (_connected_to_WDATA_),    //  output,  width = 32,                   .wdata
		.WSTRB    (_connected_to_WSTRB_),    //  output,   width = 4,                   .wstrb
		.BID      (_connected_to_BID_),      //   input,  width = 18,                   .bid
