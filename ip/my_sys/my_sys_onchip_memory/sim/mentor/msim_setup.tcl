...
# ----------------------------------------
# If my_sys_onchip_memory is one of several IP cores in your
...
# ----------------------------------------
# ACDS 23.3 104 linux 2023.10.06.07:01:21
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "my_sys_onchip_memory.my_sys_onchip_memory"
}
...
append ELAB_OPTIONS [subst [my_sys_onchip_memory::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [my_sys_onchip_memory::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [my_sys_onchip_memory::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [my_sys_onchip_memory::normalize_path "$file"]
  set normalized_dest [my_sys_onchip_memory::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [my_sys_onchip_memory::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [my_sys_onchip_memory::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [my_sys_onchip_memory::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [my_sys_onchip_memory::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
